...
function Panduan() {
  ...
  const handleOnClick = () => {
    ...
    history.push('/aktivitas-saya/create')
  }
    ...
    <div className="mx-auto" style={{ maxWidth: '430px' }}>
      ...
      <div className="rounded-t-[30px] bg-white  w-full relative -top-10 shadow-sm">
        <div className="mx-[20px]">
          ...
          <div
            className="flex rounded-[15px] py-[20px] px-[15px] mt-[24px] bg-peduly-primary-12/100"
          ...
          <div
            className="flex rounded-[15px] py-[20px] px-[15px] mt-[20px] bg-peduly-primary-12/100"
          // style={{ backgroundColor: 'rgba(231, 81, 59, 0.12)' }}
          >
            <span>
              <svg
