  ...
  return (
    <div>
      ...
      <div className="mx-auto" style={{ maxWidth: '430px' }}>
        ...
        />
        <BackButton hrf={`/profile`} txt="Pengaturan" />
      ...
      >
        <hr style={{ width: '90%', margin: 'auto' }} />
          ...
          <Link
            to={{
              pathname: 'https://help.involuntir.com/syarat-dan-ketentuan/',
            }}
            target="_blank"
          >
            <div className="grid grid-cols-6 py-[25px]  w-full  align-middle">
          ...
          <div className="cursor-pointer" onClick={() => setPopUp(true)}>
            {/* <div className="py-[25px]">
              <button className="rounded-full border-[1px] border-peduly-primary text-base font-normal text-peduly-primary w-full px-3 py-[18px] ">
                Keluar
              </button>
            </div> */}
          </div>
